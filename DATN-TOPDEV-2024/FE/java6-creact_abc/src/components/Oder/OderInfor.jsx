    ...
    <div>
        ...
        <div className="border border-gray-300 rounded-md p-4">
            <table className="w-full text-left">
                ...
                <tbody>
                <tr>
                    <td>Air Purifier for Home Allergies Pets Hair in Bedroom × 1</td>
                    <td>590,000₫</td>
                </tr>
                <tr>
                    <td>Acer SB220Q bi 21.5 Inches Full HD (1920 x 1080) IPS × 1</td>
                    <td>20,000,000₫</td>
                </tr>
                <tr>
                    <td>Amazon Essentials Women's Digital Chronograph × 1</td>
                    <td>1,800,000₫</td>
                </tr>
                </tbody>
                <tfoot>
                <tr>
                    ...
                    <td className="pt-2">22,390,000₫</td>
                </tr>
                <tr>
                    <td className="pt-2 font-bold">Tổng</td>
                    <td className="pt-2 font-bold">22,390,000₫</td>
                </tr>
                </tfoot>
            </table>
            <div className="mt-4">
