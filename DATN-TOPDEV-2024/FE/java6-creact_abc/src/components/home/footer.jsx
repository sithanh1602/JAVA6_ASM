        ...
        <footer className="bg-black text-white py-10">
            <div className="container mx-auto px-4">
                ...
                <div className="flex flex-col lg:flex-row justify-between items-center border-b border-gray-700 pb-6">
                    <div>
                        <h2 className="text-2xl font-semibold text-primary-500">Đăng Ký Tin Tức</h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mt-8 px-7">
                    ...
                    <div>
                        <div className="flex items-center space-x-4">
                            ...
                            <div className="flex flex-col">
                                ...
                                <span className="text-primary-300 text-xs">TECHNOLOGY</span>
                            </div>
                        </div>
                        ...
                        <div className="mt-4">
                            <p className="flex items-center text-gray-400">
                                <span className="mr-2 text-primary-500">&#10149;</span> info@fivestar.team
                            </p>
                            <p className="flex items-center text-gray-400 mt-2">
                                <span className="mr-2 text-primary-500">&#9742;</span> (+84) 0313-728-397
                            </p>
                        </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-gray-400">
                            <li>
                                <a href="/aboutUs" className="hover:text-primary-500 transition-colors">
                                Giới thiệu
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="/news" className="hover:text-primary-500 transition-colors">Tin tức
                                </a>
                            </li>
                        </ul>
                ...
                <div className="mt-8 text-center text-gray-500 text-sm">
                    © Thiết kế và lập trình bởi <span className="text-primary-500">Five-Star Team</span>
                </div>
            </div>
        </footer>
