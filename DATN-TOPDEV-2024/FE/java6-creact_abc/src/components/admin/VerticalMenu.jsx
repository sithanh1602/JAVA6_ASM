...
const VerticalMenu = ({ isOpen, toggleMenu }) => {
  ...
  const menuItems = [
    ...
    {
      icon: <FaFirstOrder className="text-blue-500 dark:text-blue-400" />,
      label: "Quản lý hoá đơn",
      link: "/admin/order",
    },
    {
      icon: <MdCategory className="text-red-500 dark:text-red-400" />,
      label: "Quản lý loại sản phẩm",
      link: "/admin/category",
    },
    {
      icon: <FaDisease className="text-red-500 dark:text-red-400" />,
      label: "Quản lý thương hiệu",
      link: "/admin/brand",
    },
    {
      icon: <FaProductHunt className="text-orange-500 dark:text-orange-400" />,
      label: "Quản lý sản phẩm",
      link: "/admin/product",
    },
    {
      icon: <FaDesktop className="text-green-500 dark:text-green-400" />,
      label: "Cấu hình PC",
      link: "/admin/pc-builds",
    },
    {
      icon: <FaDonate className="text-green-500 dark:text-green-400" />,
    ...
    {
      icon: <FaUser className="text-pink-500 dark:text-pink-400" />,
      label: "Quản lý người dùng",
      link: "/admin/user",
    },
    {
      icon: <FaEnvelope className="text-purple-500 dark:text-purple-400" />,
      label: "Quản lý phản hồi",
      link: "/admin/contact",
    },
    {
      icon: <FaPencilAlt className="text-blue-500 dark:text-blue-400" />,
      label: "Bài viết",
      hasArrow: true,
      subItems: [
        { label: "Danh sách bài viết", link: "/admin/post" },
        { label: "Thêm tag", link: "/admin/post/tag" },
        { label: "Thêm danh mục", link: "/admin/post/category" },
      ],
    },
    // {
    //   icon: <FaPuzzlePiece className="text-pink-500 dark:text-pink-400" />,
    //   label: "UI Elements",
    //   link: "/ui-elements",
    // },
    // {
    //   icon: <FaTable className="text-orange-500 dark:text-orange-400" />,
    //   label: "Tables",
    //   hasArrow: true,
    //   subItems: [
    ...
    // },
    {
      icon: <FaUser className="text-red-500 dark:text-red-400" />,
      label: "Đăng xuất",
      action: "logout",
    },
  ];
