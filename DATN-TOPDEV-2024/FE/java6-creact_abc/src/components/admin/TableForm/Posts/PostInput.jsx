...
const PostInput = ({ post, onClose }) => {
    ...
    const handleImageChange = (event) => {
        ...
        if (file) {
            setImageFile(file);
            setImageError(""); // Xóa thông báo lỗi khi chọn ảnh
    ...
    const getUserFromToken = () => {
        ...
        try {
            ...
            return {
                ...
                fullName: decodedToken.fullName, // Lấy tên người dùng
                avatar: decodedToken.avatar,   // Lấy ảnh đại diện người dùng
            };
        } catch (err) {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            // Đóng modal sau khi thêm/cập nhật thành công
            if (onClose) {
                onClose();
            }
        } catch (error) {
